...
namespace AzCourse.DPS.Sample
{
    ...
    {
        const string PRIMARY_KEY = @""; // The primary key of the enrollment group
        const string ID_SCOPE = ""; // Can be found on the overview page of the DPS

        // The following consts should not be changed
        const string DESIRED_DEVICE_ID = "myDPSDevice"; // The device ID to be provisioned
        const string GLOBAL_ENDPOINT = "global.azure-devices-provisioning.net"; // The global endpoint of the DPS. It'll be constant for all DPS instances
